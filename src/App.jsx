...
export default function App() {
  ...
  const views = {
    visual: <VisualView go={setView} requireAuth={requireAuth} />,
    table: <TableView go={setView} requireAuth={requireAuth} />,
    stats: <StatsView />,
    manage: loggedIn ? <ManageView go={setView} /> : <Center>Debes iniciar sesión</Center>,
  ...
  return (
    <div style={{ minHeight: '100vh', background: T.bg }}>
      <Nav view={view} setView={setView} requireAuth={requireAuth} onAuth={() => setAuthOpen(true)} />
